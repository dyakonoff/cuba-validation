package io.dyakonoff.validationannotations;
...
public class ValidationannotationsTestContainer extends TestContainer {

    public ValidationannotationsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "io/dyakonoff/validationannotations/app.properties",
    ...
    public static class Common extends ValidationannotationsTestContainer {

        public static final ValidationannotationsTestContainer.Common INSTANCE = new ValidationannotationsTestContainer.Common();
