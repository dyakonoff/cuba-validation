package io.dyakonoff.controllersvalidation;
...
public class ControllersvalidationTestContainer extends TestContainer {

    public ControllersvalidationTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "io/dyakonoff/controllersvalidation/app.properties",
    ...
    public static class Common extends ControllersvalidationTestContainer {

        public static final ControllersvalidationTestContainer.Common INSTANCE = new ControllersvalidationTestContainer.Common();
