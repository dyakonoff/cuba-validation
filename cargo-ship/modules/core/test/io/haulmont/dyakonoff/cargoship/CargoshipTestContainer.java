package io.haulmont.dyakonoff.cargoship;
...
public class CargoshipTestContainer extends TestContainer {

    public CargoshipTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "io/haulmont/dyakonoff/cargoship/app.properties",
    ...
    public static class Common extends CargoshipTestContainer {

        public static final CargoshipTestContainer.Common INSTANCE = new CargoshipTestContainer.Common();
