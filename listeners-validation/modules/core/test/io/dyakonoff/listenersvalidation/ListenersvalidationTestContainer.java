package io.dyakonoff.listenersvalidation;
...
public class ListenersvalidationTestContainer extends TestContainer {

    public ListenersvalidationTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "io/dyakonoff/listenersvalidation/app.properties",
    ...
    public static class Common extends ListenersvalidationTestContainer {

        public static final ListenersvalidationTestContainer.Common INSTANCE = new ListenersvalidationTestContainer.Common();
