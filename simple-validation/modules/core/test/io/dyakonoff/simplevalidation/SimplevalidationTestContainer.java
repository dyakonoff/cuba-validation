package io.dyakonoff.simplevalidation;
...
public class SimplevalidationTestContainer extends TestContainer {

    public SimplevalidationTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "io/dyakonoff/simplevalidation/app.properties",
    ...
    public static class Common extends SimplevalidationTestContainer {

        public static final SimplevalidationTestContainer.Common INSTANCE = new SimplevalidationTestContainer.Common();
