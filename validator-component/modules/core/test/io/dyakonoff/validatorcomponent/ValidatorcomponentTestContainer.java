package io.dyakonoff.validatorcomponent;
...
public class ValidatorcomponentTestContainer extends TestContainer {

    public ValidatorcomponentTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "io/dyakonoff/validatorcomponent/app.properties",
    ...
    public static class Common extends ValidatorcomponentTestContainer {

        public static final ValidatorcomponentTestContainer.Common INSTANCE = new ValidatorcomponentTestContainer.Common();
