package com.haulmont.dyakonoff.orderman;
...
public class OrdermanTestContainer extends TestContainer {

    public OrdermanTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/dyakonoff/orderman/app.properties",
    ...
    public static class Common extends OrdermanTestContainer {

        public static final OrdermanTestContainer.Common INSTANCE = new OrdermanTestContainer.Common();
